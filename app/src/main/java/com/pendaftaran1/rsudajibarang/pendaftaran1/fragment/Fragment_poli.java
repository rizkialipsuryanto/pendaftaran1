    ...
    private void writeListView(String response){
        ...
        try {
            ...
            poliklinikAdapter = new PoliklinikAdapter(getContext(), goodModelPoliklinikArrayList,new PoliklinikAdapter.OnItemClickListener() {
                @Override
                public void onItemClick(mPoliklinik item, int posisi) {
                    Log.e("jalan poli", String.valueOf(posisi));
//                    daftarFragmentPoli();
//                    showDialogPoli();
                    String poli;
                    poli = "poli anak";
...
//        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(getActivity());
//        // set title dialog
//        alertDialogBuilder.setTitle("ANDA MEMILIH "+poli+"?");
//
//        // set pesan dari dialog
//        alertDialogBuilder
//                .setMessage("Klik Ya untuk pilih dokter!")
...
//    }
    ...
    public void daftarFragmentPoli() {
        ...
        String token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEyIiwiZW1haWwiOiJhcmlndXN3YWh5dS5pZEBnbWFpbC5jb20iLCJmaXJzdG5hbWUiOiItLS0tIiwibGFzdG5hbWUiOiItLS0iLCJjZWsiOnRydWUsImlhdCI6MTU4NDM0MDYzNSwiZXhwIjoxNTg0MzU4NjM1fQ.JVQjVxSI1x9_5C2oDcqJ8Xe8SMloJkAuYELAjDBfUdk";
        Log.d("OBJEK", "Jalan-----");
        Log.d("OBJEK", getnorm);
